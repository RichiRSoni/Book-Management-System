...
@section('content')
	...
	{{-- <div class="welcome"> --}}
		<div class="container">
			<!-- tittle heading -->
			<h3 class="tittle-w3l">About BookShoppy
			...
			<div class="w3l-welcome-info">
				<div class="col-sm-6 col-xs-6 welcome-grids">
					{{-- <div class="welcome-img"> --}}
						<img src="/images/background2.jpg" class="img-responsive zoom-img" alt="ss" width="400">
					{{-- </div> --}}
				</div>
				<div class="col-sm-6 col-xs-6 welcome-grids">
					{{-- <div class="welcome-img"> --}}
						<img src="/images/background3.jpg" class="img-responsive zoom-img" alt="ab" width="400">
					{{-- </div> --}}
				</div>
