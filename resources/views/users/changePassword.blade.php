        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header">
                    <center><h3>Change Password</h3></div></center>
                    <br/>
                <div class="card-body">
                    <form method="POST" action="{{ route('change.password') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password"  name="current_password" class="form-control @error('current_password') is-invalid @enderror" value="{{old('current_password')}}" autocomplete="current-password">
